...
def _launch_nodes(context, *args, **kwargs):
    ...
    adapter_params = {
        ...
        "enable_lidar_bridge": _bool_text(_text(context, "enable_lidar_bridge")),
        "utm_origin": _text(context, "utm_origin"),
        "utm_origin_output_path": _text(context, "utm_origin_output_path"),
        "T_world_utm_path": _text(context, "T_world_utm_path"),
